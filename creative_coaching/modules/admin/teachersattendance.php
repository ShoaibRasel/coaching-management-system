...
?>
                    ...
                    <form method="post">
                        <table>
                            <tr>
                                <td>EID :</td>
                                <td>
                                     <select name="teacher_eid">
                                        <option value="none">Select EID</option>
                                    <?php
                                        $sql_get_teacher = "SELECT * FROM teacher WHERE course='$course' AND NOT position='admin' order by eid";
                            ...
                            <tr>
                                <td> Time To IN:</td>
                                <td> <input type="text" name="timetoin" placeholder="Time To In"></td>
                            </tr>
                            <tr>
                                <td>Time To Leave:</td>
                                <td><input type="text" name="timetoout" placeholder="Time To Leave"></td>
                            </tr>
                            <tr>
                                <td>Status</td>
                                <td>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="submit" name="mark" value="Mark"></td>
                            </tr>
                        </table>
                    </form>
                </div>
        <?php
            if(isset($_POST['mark'])){
                ...
                $sql_get_results = "SELECT * FROM tea_attendance WHERE eid='$get_eid' AND date='$date'AND course='$course'";
                ...
                if($neeh>0){
                    ...
                    $insert_into_tea_attendance = "INSERT INTO tea_attendance(eid, date, timetocome, timetogo, bywhom, status, course) VALUES ('$get_eid','$date','$get_timein','$get_timeout','$eid','$get_status','$course')";
        ...
        if(isset($_POST['update'])){
            ...
            $get_teacher_attendance = "SELECT * FROM tea_attendance WHERE eid='$het_eid' AND date='$dateofattrndance' AND course='$course'";
...
<hr>
                    <form method="post">
                        <table>
                            <tr>
                                <td><b>EID: </b></td>
                                <td><input type="text" name="as" value="<?php echo $het_eid?>" disabled></td>
                            </tr>
                            <tr>
                                <td><b>Date: </b></td>
                                <td> <input type="date" name="as" value="<?php echo $dateofattrndance?>" disabled></td>
                            </tr>
                            <tr>
                                <td><b>Previous Status :</b></td>
                                <td><input type="text" value="<?php echo $r['status'] ?>" disabled></td>
                            </tr>
                            <tr>
                                <td><b>Update New Status: </b></td>
                                <td>
                            ...
                            <tr>
                                <td> <b>Time To in: </b></td>
                                <td><input type="text" name="timetoinn" value="<?php echo $r['timetocome']?>"></td>
                            </tr>
                            <tr>
                                <td><b>Time To out: </b></td>
                                <td> <input type="text" name="timetogoout" value="<?php echo $r['timetogo']?>"></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input type="submit" name="updatedetails" value="Change"></td>
                            </tr>
                        </table>
                    </form>
                </div>
            ...
            <?php
                ...
                if(isset($_POST['updatedetails'])){
                    ...
                    $udaye = "UPDATE tea_attendance SET status='$get_new_status',timetocome='$get_new_in',timetogo='$get_new_out' WHERE eid='$het_eid'AND date ='$dateofattrndance' AND course='$course'";
