...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    if($row = mysqli_fetch_assoc($result)){
        ...
        <head>
            ...
            <title>Search-Teachers-CACC</title>
            <link rel="stylesheet" type="text/css" href="css/style.css">
        </head>
        <body>
        <h2 align="center" style="color: blue"> Search</h2>
        <div class="header">
        ...
        if(isset($_GET['search'])){
            ...
            if($rowss = mysqli_fetch_assoc($sql_search_result)){
                $name_student = $rowss['name'];
                $phone_student = $rowss['mobile'];
                $course_student = $rowss['course'];
                $batch_student = $rowss['batch'];
            }else{
                $name_student = "not found";
        ...
        <div align="center">
            <table>
                ...
                <tr>
                    <td></td>
                    <td class="btn">
                        <?php echo '<a href="search.php"> Back</a>'; ?> 
                    </td>
